...
class Config:
    ...
    # Alert thresholds
    ALERT_DAYS_BEFORE: int = field(default_factory=lambda: int(os.getenv("ALERT_DAYS_BEFORE", "7")))
    CRITICAL_DAYS_BEFORE: int = field(default_factory=lambda: int(os.getenv("CRITICAL_DAYS_BEFORE", "2")))
    ...
    EMAIL_FROM: str = field(default_factory=lambda: os.getenv("EMAIL_FROM", "alerts@shelby.io"))
    ...
    SHELBY_API_URL: str = field(default_factory=lambda: os.getenv("SHELBY_API_URL", "https://api.shelby.io"))
    SHELBY_API_KEY: Optional[str] = field(default_factory=lambda: os.getenv("SHELBY_API_KEY"))
